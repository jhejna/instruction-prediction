...
class StateEncoderFree(nn.Module):
    ...
    def forward(self, grid_embedding, grid_onehot, inventory):
        ...
        encoder_out = torch.cat((grid_embedding, onehot, inventory), dim=1)
        return encoder_out
...
class MetaViT(nn.Module):
    ...
    def __init__(self, num_actions, vocab, embed_weights, embed_dim=128, depth=4,
        ...
        self.num_img_tokens = 25 + 25 + 1 # Grid Emb, Grid Onehot, inventory
    ...
    def forward(self, obs):
        ...
        x = self.state_encoder(grid_embedding, grid_onehot, inventory)
        ...
        return action_logits, lang_logits # For unsupervised losses to be used later perhaps

...
from language_prediction.datasets.meta_crafting_dataset import MetaCraftingDataset
...
def read_dataset(save_path):
    ...
    for trace in dataset:
        ...
        for indiv_game in game:
            ...
            assert len(ep_states) == len(ep_inventories) == len(ep_actions)

            ep = {
                "state": ep_states,
                "inventory": ep_inventories,
                "action": ep_actions,
